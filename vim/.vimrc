...
" Wildignore
set wildignore+=*.dSYM,node_modules,bower_components,vendor/*,tmp,dist/*,_site,CMakeFiles,cmake_install.cmake,CMakeCache.txt,system/*,__pycache__
...
map <Leader>f :pyf /usr/local/Cellar/clang-format/2016-08-03/share/clang/clang-format.py<CR>
